...
namespace MultiTablePro
{
    class InputSender
    {
        ...
        public static void RedirectHotkey(HotKey hk)
        {
            KeyCode modifierKey = 0;
            switch (hk.Modifier)
            {
                case ModifierKeys.Alt:
                    modifierKey = KeyCode.ALT;
                    break;
                case ModifierKeys.Control:
                    modifierKey = KeyCode.CONTROL;
                    break;
                case ModifierKeys.Shift:
                    modifierKey = KeyCode.SHIFT;
                    break;
                case ModifierKeys.Windows:
                    modifierKey = KeyCode.LWIN;
                    break;
            }
            ...
            // Send keypress (KeyCode matches Forms.Keys)
            SendKeyPress((KeyCode)hk.Key);
